...
ta_bm_detuning = shot_globals.ta_bm_detuning # MHz, bright molasses detuning
repump_bm_detuning = shot_globals.repump_bm_detuning # MHz, bright molasses detuning
