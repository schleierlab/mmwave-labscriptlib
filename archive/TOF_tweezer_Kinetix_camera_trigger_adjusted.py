...
if shot_globals.do_kinetix_camera:
    ...
    print('kinetix_readout_time')

    devices.kinetix.expose(
        'Kinetix',
        t - kinetix_readout_time,
        'atoms',
        exposure_time= kinetix_readout_time + shot_globals.kinetix_exposure,
    )
...
if shot_globals.do_kinetix_camera:
    ...
    # devices.kinetix_camera_trigger.go_low(t)
