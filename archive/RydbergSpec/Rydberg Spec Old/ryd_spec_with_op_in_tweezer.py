...
if shot_globals.do_tw_power_ramp == True:
...
devices.tweezer_aom_analog.constant(t,0.15) #lower trap for blue resonance beam
...
devices.tweezer_aom_analog.constant(t,1) #turn trap back to full power
