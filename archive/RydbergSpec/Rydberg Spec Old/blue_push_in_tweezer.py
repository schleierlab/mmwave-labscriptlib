...
# devices.mirror_1_vertical = shot_globals.piezo_mirror_1_vertical
# devices.mirror_1_horizontal = shot_globals.piezo_mirror_1_horizontal
# devices.mirror_2_vertical = shot_globals.piezo_mirror_2_vertical
# devices.mirror_2_horizontal = shot_globals.piezo_mirror_2_horizontal

devices.mirror_1_vertical = 5
devices.mirror_1_horizontal = 4
devices.mirror_2_vertical = 5
devices.mirror_2_horizontal = 5
