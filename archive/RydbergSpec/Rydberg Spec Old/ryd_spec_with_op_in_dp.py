...
# move piezo mirror to position
# waiting for Thorlabs to comment on maximum voltage step for the piezo mirrors
# large steps might damage piezos?
...
if shot_globals.do_rydberg_beams:
    devices.ipg_1064_aom_analog.constant(t-3e-3,shot_globals.ipg_1064_Rydberg_power)
    ...
    t += shot_globals.blue_456nm_duration
...
# turn trap off for taking background image
if shot_globals.do_dipole_trap:
    devices.ipg_1064_aom_analog.constant(t,0)
    devices.ipg_1064_aom_digital.go_low(t)
