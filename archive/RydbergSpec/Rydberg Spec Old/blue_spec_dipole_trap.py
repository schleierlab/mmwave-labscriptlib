...
devices.dds1.synthesize(t, blue_456_detuning , 0.2, 0) # setup the frequency  for the dds
if shot_globals.do_456nm_laser:
    ...
    dur = shot_globals.blue_456nm_duration
...
# Turn off dipole trap for taking background images
