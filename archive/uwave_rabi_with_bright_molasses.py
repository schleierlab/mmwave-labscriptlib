...
ta_bm_detuning = -35 #-100 # bright molasses detuning
...
t += 0.1 #0.1 # how long MOT last

# Bright molasses stage
load_molasses(t, ta_bm_detuning)
...
if shot_globals.mw_dorepump:  # Turn on the repump during imaging depending on the global variable
    devices.ta_aom_analog.constant(t, 1) # for better exposure of the both F=3 and F=4 atom
