...
# imaging X beam work as the blowing beam
if shot_globals.do_blow_beam:
    t += 3e-3
    devices.img_z_shutter.open(t)
    devices.img_z_shutter.close(t + shot_globals.blow_beam_time)
    devices.ta_aom_analog.constant(t , 0.1) # change power for blowing
    devices.ta_aom_digital.go_high(t)
    devices.ta_aom_digital.go_low(t + shot_globals.blow_beam_time)
    devices.repump_aom_digital.go_high(t)
    devices.repump_aom_digital.go_low(t + shot_globals.blow_beam_time)
    t -= 3e-3
